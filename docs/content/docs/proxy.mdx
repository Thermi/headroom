...
| `--retry-base-delay-ms` / `HEADROOM_RETRY_BASE_DELAY_MS` | `1000` | Initial upstream retry delay in milliseconds. |
| `--retry-max-delay-ms` / `HEADROOM_RETRY_MAX_DELAY_MS` | `30000` | Maximum upstream retry delay in milliseconds. |
