...
class SavingsTracker:
    ...
    # Debounce threshold for _save_locked: avoid writing to disk more often
    # than once every N seconds on a busy proxy.
    _SAVE_DEBOUNCE_SECONDS = 2.0

    def _save_locked(self) -> None:
        now = time.time()
        # Debounce: skip the actual write if we wrote recently.
        # The in-memory state is always up to date; the disk is just
        # for crash recovery and dashboard queries.
