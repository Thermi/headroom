...
SETTINGS: tuple[SettingField, ...] = (
    ...
    SettingField(
        ...
        "bool",
        default=False,
        help="Do not inject the CCR headroom_retrieve tool.",
        tier="advanced",
    ),
    SettingField(
        ...
        "bool",
        default=False,
        help="Do not add CCR retrieval markers to compressed content.",
        tier="advanced",
    ),
    # --- Limits ---
    SettingField(
    ...
    SettingField(
        "HEADROOM_MAX_MEMORY_BYTES",
        "max_memory_bytes",
        "Maximum rendered memory bytes",
        "Memory",
        "int",
        default=None,
        minimum=1,
        help="Maximum byte size of rendered memory content before trimming.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_NO_INLINE_TOOLS",
        "no_inline_tools",
        "Disable inline tools",
        "Memory",
        "bool",
        default=False,
        help="Disable all inline tool injection.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_NO_DS4_SUBSCRIPTION",
        "no_ds4_subscription",
        "Disable DS4 subscription tracking",
        "Subscriptions",
        "bool",
        default=False,
        help="Disable DS4 subscription usage tracking.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_DS4_BUDGET",
        ...
        default=None,
        minimum=0.0,
        help="DS4 subscription budget limit in USD.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_DS4_BUDGET_PERIOD",
        "ds4_budget_period",
        "DS4 budget period",
        "Subscriptions",
        "enum",
        default="daily",
        choices=("hourly", "daily", "monthly"),
        help="DS4 budget period.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_NO_FILE_LOG",
        "no_file_log",
        "Disable file logging",
        "Logging",
        "bool",
        default=False,
        help="Disable the proxy file log.",
        tier="advanced",
    ),
    SettingField(
        "HEADROOM_MODEL_COST_MAP",
        "model_cost_map",
        "Model cost map",
        "Backend",
        "str",
        default=None,
        help="JSON object mapping model names to LiteLLM cost parameters.",
        tier="advanced",
    ),
